...
func ID(id int64) predicate.Alert {
...
func IDEQ(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func IDIn(ids ...int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func IDNotIn(ids ...int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func IDGTE(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func IDLT(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func IDLTE(id int64) predicate.Alert {
	return predicate.Alert(func(s *sql.Selector) {
...
func Status(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func State(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StatusEQ(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), vc))
	})
...
func StatusNEQ(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StatusIn(vs ...schema.AlertStatus) predicate.Alert {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StatusNotIn(vs ...schema.AlertStatus) predicate.Alert {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StatusGT(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StatusGTE(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StatusLT(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StatusLTE(v schema.AlertStatus) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StateEQ(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldState), vc))
	})
...
func StateNEQ(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StateIn(vs ...schema.AlertState) predicate.Alert {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StateNotIn(vs ...schema.AlertState) predicate.Alert {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StateGT(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StateGTE(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StateLT(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
...
func StateLTE(v schema.AlertState) predicate.Alert {
	vc := int8(v)
	return predicate.Alert(func(s *sql.Selector) {
