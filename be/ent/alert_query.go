...
func (aq *AlertQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (aq *AlertQuery) FirstXID(ctx context.Context) int64 {
...
func (aq *AlertQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (aq *AlertQuery) OnlyIDX(ctx context.Context) int64 {
...
func (aq *AlertQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (aq *AlertQuery) IDsX(ctx context.Context) []int64 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
