...
func (dd *DatasourceDelete) Where(ps ...predicate.Datasource) *DatasourceDelete {
	dd.predicates = append(dd.predicates, ps...)
	return dd
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (dd *DatasourceDelete) Exec(ctx context.Context) (int, error) {
	var (
		err      error
		affected int
	)
...
func (dd *DatasourceDelete) ExecX(ctx context.Context) int {
	n, err := dd.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (dd *DatasourceDelete) sqlExec(ctx context.Context) (int, error) {
...
func (ddo *DatasourceDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (ddo *DatasourceDeleteOne) ExecX(ctx context.Context) {
	ddo.dd.ExecX(ctx)
}
